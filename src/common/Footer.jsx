                ...
                <Stack 
                    ...
                    >
                        <Stack 
                            ...
                            spacing={1}
                            >
                            <Typography variant='h6' fontWeight={600} p={1} fontFamily="lato">Company</Typography>
                        ...
                        <Stack 
                            ...
                            alignItems="flex-start"
                            spacing={1}>
                            <Typography variant='h6' fontWeight={600} p={1} fontFamily="lato">Support</Typography>
                        ...
                        <Stack 
                            ...
                            alignItems="flex-start"
                            spacing={1}>
                            <Typography variant='h6' fontWeight={600} p={1} fontFamily="lato">Learn</Typography>
                        ...
                        <Stack>
                            <Typography variant='h6' fontWeight={600} p={1} textAlign='center' fontFamily="lato">Social</Typography>
                                <Box
                                    display='flex'
                                    alignItems='flex-start'
                                    > 
